...
- [#4410](https://github.com/Effect-TS/effect/pull/4410) [`58a6f9d`](https://github.com/Effect-TS/effect/commit/58a6f9d7b4c0c79b2801be9eddd78bc3c4994f11) Thanks @vecerek! - Use an unprepared `SELECT 1` statement to test the DB connection during client initialization instead of a prepared statement.
...
- [#3380](https://github.com/Effect-TS/effect/pull/3380) [`db1dbc6`](https://github.com/Effect-TS/effect/commit/db1dbc694bfdd4d70d9686cc62db0938dd21d7ac) Thanks @ecyrbe! - make mssql placeholder format compatible with kysely
